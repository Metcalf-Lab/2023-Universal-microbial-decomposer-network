...
Metab_soil = Metab_soil.filter_abundance(cutoff=1)
...
Metab_soil_meta = Metab_soil.add_sample_metadata_as_features(['facility'])
...
with open('Metab_soil_allpred_output.csv', 'w') as f:
