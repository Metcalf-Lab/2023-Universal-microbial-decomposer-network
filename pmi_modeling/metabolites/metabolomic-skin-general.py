...
allMetab = ca.read_amplicon('final_filtered_table.biom','pmi3_metab_meta_ml.txt', min_reads=0, normalize = None)
...
allMetab = allMetab.filter_samples('soil_control', 'n')
allMetab.sample_metadata.subjectID.value_counts()
...
Metab_skin = Metab_skin.filter_abundance(cutoff=1)
...
Metab_skin_meta = Metab_skin.add_sample_metadata_as_features(['facility'])
...
with open('Metab_skin_allpred_output.csv', 'w') as f:
