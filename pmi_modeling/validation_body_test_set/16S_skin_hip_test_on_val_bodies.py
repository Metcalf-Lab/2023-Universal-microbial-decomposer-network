...
# ### Import validation data and filter to keep skin samples
...
validation = validation.filter_samples('model_type', 'skin')
...
pmi = pmi.filter_samples('sample_site', 'skin.hip')
...
regressor.fit(X, y)
joblib.dump(regressor, 'PMI3_all_16S_skin_hip_species_general.pkl')
regressor = joblib.load('PMI3_all_16S_skin_hip_species_general.pkl')
...
f = open('skin_hip_validation_results.csv', 'w')
...
f = open('skin_hip_validation_rand_results.csv', 'w')
