...
#############################################################################################################
allShotgun = ca.read_amplicon('modules_filtered_table.biom','shotgun_metadata_ml.txt', min_reads=0, normalize = None)
...
with open('MAG_modules_allpred_output.csv', 'w') as f:
